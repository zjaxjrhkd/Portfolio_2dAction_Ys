...
public class HandShooter : MonoBehaviour
{
    ...
    private Vector3 CalculatePosition(Vector3 basePosition,
        Vector3 forward, float angleDegrees, float distance)
    {
    ...
    {
        Vector3 newPosition = CalculatePosition(target.position, target.forward, 240f + spin, distance);
